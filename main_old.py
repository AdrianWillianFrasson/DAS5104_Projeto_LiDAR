...
def main():
    ...
    print(sensor_top.set_parameters(samples_per_scan=600, scan_frequency=40))
    ...
    print(sensor_top.request_handle_udp(max_num_points_scan=600, skip_scans=35, packet_type="B"))
